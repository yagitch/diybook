...
Amazon Echo dot（画像）
Amazon Alexaが使えればサードパーティ製または上位機種でも可
...
== Node-RED 上で Amazon Alexa とシェルスクリプトを繋げる
...
Amazon Echo dot に「アレクサ、ライトをオンにして」と話しかけてください。正しく反応すれば「はい」と回答して Hue が点きます。

もし「すみません、よく分かりません」などと言われたり、反応音がしつつも何も返してくれない場合は正しく聞き取れていません。私の実感では、いちいち声を張らず小声でボソボソ言っても拾って反応してくれます。

あるいは「ライトが見つかりません」と言われたらスキルが Amazon Echo dot に正しく設定されていません。たとえばひらがなで「らいと」と設定すると認識されません。推測ですが、Amazon Alexa の持っている辞書表記に一字一句合わないと見つからない扱いになるようです。
